...
import { Clock, CheckCircle2, AlertTriangle, ArrowUpRight, GitPullRequest, FileText, Eye } from 'lucide-react';
      ...
      <div className="rounded-2xl border border-slate-200/90 bg-white p-6 shadow-xs">
        <div className="flex items-center justify-between border-b border-slate-100 pb-4 mb-4">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Real-time submissions recorded in Supabase (Click review to inspect full report)</p>
          </div>
                  ...
                  <tr key={report.id} className="group transition hover:bg-slate-50/70">
                    ...
                    <td className="py-3.5 pl-4 text-right">
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-lg bg-slate-100 hover:bg-blue-50 text-slate-700 hover:text-blue-700 px-3 py-1.5 text-[11px] font-bold transition"
                      >
