...
export function Navbar({ onOpenInviteModal, onOpenProjectModal, onOpenProfileModal }: NavbarProps) {
      ...
      <header className="sticky top-0 z-30 flex h-16 w-full items-center justify-between border-b border-slate-200 bg-white/95 px-6 backdrop-blur-md">
        ...
        <div className="flex items-center gap-3.5">
          ...
          {activeUser.role === 'admin' && (
            <div className="hidden md:flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-3.5 py-1 text-xs font-semibold text-blue-900 shadow-2xs">
