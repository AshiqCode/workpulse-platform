            ...
            <div className="divide-y divide-slate-100">
              ...
              <div className="flex items-center justify-between py-3.5">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <p className="text-xs font-bold text-slate-900">Sarah Johnson (You)</p>
                    <p className="text-[11px] text-slate-500">sarah.johnson@workpulse.io</p>
                  </div>
                </div>
